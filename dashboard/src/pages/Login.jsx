          ...
          <div className="p-8">
            ...
            {activeTab === 'player' ? (
                ...
                <form onSubmit={handlePlayerSubmit} className="space-y-5">
                  <div>
                    <label htmlFor="fid" className="block text-xs font-black uppercase tracking-widest text-gray-500 mb-2">Game ID (FID)</label>
                    <input
                        id="fid"
                        type="number"
                ...
                <form onSubmit={handleStaffSubmit} className="space-y-5">
                  {step === 1 ? (
                      <>
                        <div>
                          <label htmlFor="username" className="block text-xs font-black uppercase tracking-widest text-gray-500 mb-2">Username</label>
                          <input
                              id="username"
                              type="text"
                        ...
                        <div>
                          <label htmlFor="password" className="block text-xs font-black uppercase tracking-widest text-gray-500 mb-2">Password</label>
                          <input
                              id="password"
                              type="password"
                              className="w-full bg-black border border-gray-800 rounded-xl px-4 py-3 focus:border-purple-500 focus:outline-none text-white transition-colors"
