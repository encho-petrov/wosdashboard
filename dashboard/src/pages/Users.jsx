        ...
        <div className="p-4 lg:p-6 flex flex-col lg:flex-row gap-6 lg:h-[calc(100vh-80px)] overflow-y-auto lg:overflow-hidden relative">
          ...
          <div className="w-full lg:w-80 shrink-0 bg-gray-800 p-6 rounded-xl border border-gray-700 h-fit shadow-lg z-10">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                <label htmlFor="username" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">Username</label>
                <input
                    id="username"
                    type="text" required
              ...
              <div>
                <label htmlFor="password" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">Temporary Password</label>
                <input
                    id="password"
              ...
              <div>
                <label htmlFor="role" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">Access Level</label>
                <select
                    id="role"
              ...
              <div className="pt-2">
                <label htmlFor="selectedAlliance" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">Alliance Assignment</label>
                <select
                    id="selectedAlliance"
              ...
              <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4 backdrop-blur-sm">
                <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 w-full max-w-sm shadow-2xl relative animate-in zoom-in-95 duration-200">
                  ...
                  <form onSubmit={handleUpdate} className="space-y-4">
                    <div>
                      <label htmlFor="editRole" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">Access Level</label>
                      <select
                          id="editRole"
                    ...
                    <div>
                      <label htmlFor="editAlliance" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">Alliance Assignment</label>
                      <select
                          id="editAlliance"
