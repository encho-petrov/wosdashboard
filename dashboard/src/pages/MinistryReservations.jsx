                                                                ...
                                                                <div className="flex-1 flex items-center justify-between px-2 border-l border-gray-700 pl-3 ml-2 min-w-0">
                                                                    {slot.playerFid ? (
                                                                        <>
                                                                            ...
                                                                            {!viewingHistory && (
                                                                                <button aria-label="Clear slot" title="Clear slot" onClick={() => handleClearSlot(slot)} className="p-1.5 text-gray-500 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-all shrink-0">
                                                                                    <X size={14} />
                                                                                </button>
                                                                            )}
                                                                        </>
                ...
                <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[70] p-4 backdrop-blur-sm">
                    <div className="bg-gray-800 p-5 rounded-3xl w-full max-w-md border border-gray-700 shadow-2xl flex flex-col max-h-[90vh]">
                        <div className="flex justify-between items-center mb-6 shrink-0">
                            ...
                            <button aria-label="Close modal" onClick={() => setSearchModal({ isOpen: false, slot: null, query: '' })} className="p-2 text-gray-500 hover:text-white bg-gray-900 rounded-xl border border-gray-700 transition-colors">
                                <X size={20}/>
                            </button>
                        </div>
