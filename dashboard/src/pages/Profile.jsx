                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-800 rounded-2xl border border-gray-700 p-6 shadow-lg">
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-4">
                            <div>
                                <label htmlFor="oldPassword" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">
                                    Current Password
                                </label>
                                <input
                                    id="oldPassword"
                            ...
                            <div>
                                <label htmlFor="newPassword" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">
                                    New Password
                                </label>
                                <input
                                    id="newPassword"
                            ...
                            <div>
                                <label htmlFor="confirmPassword" className="block text-xs font-bold text-gray-400 uppercase mb-1.5">
