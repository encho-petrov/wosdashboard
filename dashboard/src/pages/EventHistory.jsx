                                    ...
                                    return (
                                        <div key={allianceId} className="space-y-6">
                                            ...
                                            <div className="flex items-center gap-3 border-b border-gray-800 pb-2">
                                                ...
                                                <h2 className="text-xl font-black text-white tracking-widest truncate">
                                            ...
                                            <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6">
                                                <h3 className="text-red-400 font-black tracking-widest text-sm mb-4">
                                                            ...
                                                            return (
                                                                <div key={team.id} className="bg-gray-950 border border-gray-800 rounded-xl p-4 flex flex-col">
                                                                    <div className="border-b border-gray-800 pb-2 mb-2">
                                                                        ...
                                                                        <div className="text-xs text-yellow-500 mt-1 tracking-wider font-bold">
                                                                            ...
                                                                            teamPlayers.map(p => {
                                                                                ...
                                                                                return (
                                                                                    <div key={p.id} className="flex justify-between items-center py-1 border-b border-gray-800/30 last:border-0">
                                                                                        ...
                                                                                        <span className="text-[10px] font-bold text-blue-400/60 shrink-0">{baseTag}</span>
                                                                                    </div>
                                                                                );
                                                                            })
                                                                        )}
