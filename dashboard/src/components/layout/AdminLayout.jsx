                    ...
                    <Link to="/profile" onClick={() => setIsSidebarOpen(false)} className="flex items-center gap-3 px-4 py-3 bg-gray-950 rounded-xl border border-gray-800 hover:border-blue-500/50 transition-all mb-3 group relative cursor-pointer">
                        <div className="flex items-center gap-3 w-full">
                            <div className="relative">
                                ...
                                {pendingCount > 0 && (
                                    <span data-testid="pending-badge" className="absolute -top-1.5 -right-1.5 flex h-3.5 w-3.5 items-center justify-center">
            ...
            <div className="flex-1 flex flex-col min-w-0 h-screen">
                <header className="h-16 bg-gray-900/50 border-b border-gray-800 px-4 lg:px-6 flex justify-between items-center shrink-0">
                    <div className="flex items-center gap-4">
                        <button aria-label="Toggle Sidebar" onClick={() => setIsSidebarOpen(true)} className="lg:hidden p-2 text-gray-400 hover:text-white bg-gray-800 rounded-lg">
                            <Menu size={20} />
                        </button>
